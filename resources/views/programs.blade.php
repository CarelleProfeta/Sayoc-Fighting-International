...
<body>
  ...
  <main id="main">
    ...
    <section id="alt-services" class="alt-services section-bg">
        <div class="container" data-aos="fade-up">
            <div class="row justify-content-around gy-4 align-items-center">
                ...
                <div class="col-lg-5 d-flex flex-column justify-content-center">
                    <h3>Yakan</h3>
                    <p>At this stage he is introduced to the art of the blade  and continuously master the stick arts.</p>
                </div>
            </div>
        </div>
    </section><!-- End Alt Services Section 4 -->

    <!-- ======= Alt Services Section 5 ======= -->
    ...
    </section><!-- End Alt Services Section 5 -->
