        ...
        <main id="main">
            ...
            <section id="alt-services-2" class="alt-services">
                ...
                <div class="row justify-content-around gy-4">
                    ...
                    <div class="col-lg-6 img-bg" style="background-image: url(assets/img/instructor/guro2/photo3.jpg);" data-aos="zoom-in" data-aos-delay="100"></div>
                </div>
            ...
            <section id="get-started" class="get-started">
                ...
                <div class="row justify-content-between gy-4">
                    ...
                    <div class="col-lg-6 d-flex align-items-center" data-aos="fade-up" style="background-image: url(assets/img/instructor/guro2/photo2.jpg); background-size: contain; background-position: center; background-repeat: no-repeat;">
                    </div>
